...
**What is your pick-of-the-week?** I've recently started picking up a new language named Kotlin for use in Android Development, and it's fantastic. Google recently announced at Google I/O that Kotlin will become an officially supported language for Android Development. Kotlin greatly simplifies a lot of the code that you'd otherwise have to write in Java and allows features like lambda expressions that isn't available with the version of Java that is used for Android Dev. Other nice features of this language include full Interoperability with Java, default parameters, and null safety. 
