...
**What is your pick-of-the-week?** I've recently started picking up a new language named Kotlin for use in Android Development, and it's fantastic. Kotlin greatly simplifies a lot of the code that you'd otherwise have to write in Java and reminds me a lot of the Python and Swift programming languages. Other nice features of this language include full Interoperability with Java, default parameters, and null safety. 
